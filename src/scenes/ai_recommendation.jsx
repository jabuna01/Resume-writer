      ...
      <div className="content-wrapper content">
        ...
        <div className="main-content">
          <div className="tab-title-block">
            ...
            <Button variant="secondary" disabled className="text-nowrap">
              {" "}
              Save and Continue
            </Button>
          </div>
                ...
                <Popover.Body>
                  ...
                  <ul className="recomendation" id="style-3">
                    <li className="recomendation-item">
                      ...
                      <div>
                        Lorem ipsum dolor sit amet, rebum posse deterruisset mei
                        ea. Sit eu ipsum etiam corpora. Tale pertinacia vis te,
                        eu sanctus albucius duo. Id per soluta vivendum, doctus
                        dissentiet concludaturque has ei.
                      </div>
                    </li>
                    <li className="recomendation-item">
                      <Button variant="outline-secondary">
