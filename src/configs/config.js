...
export const responseObj = {
    personal_statement: {
        description: 'Programming enthusiast, loves to take on new challenges. Currently exploring back-end.'
    },
    ...
    certifications: [
        {
            ...
            certification_description: 'Built a fire detection and alert system by using sound spectrum analysis that helps to detect and prevent wildfire.'
        }
    ],
    trainings: [
        {
